<script>
  ...
  function handleForgotPassword() {
    ...
    // Simulate the logic for forgot password (e.g., sending a reset link)
    alert(`Password reset link sent to ${email}`);
    error = ''; // Clear error if everything is correct
  }
  ...
  <style>
    ...
    .back-link:hover {
      color: #b2d2c8; /* Change to a color that matches your theme */
    }
  ...
  <!-- Back Link -->
  <div class="back-link" on:click={goBack}>Back</div>
  ...
  <div class="container">
    ...
    <!-- <form on:submit|preventDefault={handleForgotPassword}> -->
     <form action="/resetpassword">
      ...
      <button type="submit" class="login-button" on:click={() => ('/resetpassword')}>Submit</button>
  ...
  <div class="navigation-container">
    ...
    <button class="nav-button" on:click={changeImage}>{">"}</button>
  </div>
